...
import com.zogbo.common.crawler.proxy.HttpProxy;
import com.zogbo.common.crawler.result.responsehandler.IResponseValidator;
import com.zogbo.common.crawler.spider.Request;
import com.zogbo.common.crawler.spider.Site;
import com.zogbo.common.crawler.spider.Spider;
		...
		try{
			...
			if (StringUtils.isEmpty(body)) {
				...
				request.getSite().setHeaders(new ArrayList<Header>(){{
					...
					add(new BasicHeader("User-Agent",UserAgents.getUserAgent(5)));
				}});
			}
